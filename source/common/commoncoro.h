...
template<template<typename> class MF, typename Tuple>
struct apply_to_tuple;

template<template<typename> class MF, typename... Elements>
...
template<template<typename> class Predicate, typename Head, typename... Elements>
